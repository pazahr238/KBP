...
if amal.Caption='«÷«›Â' then begin
                               ...
                               if sherkat_aq.RecordCount>0 then
                                  Application.MessageBox('Ìﬂ ‘—ﬂ  ﬁ»·« »« «Ì‰ ‰«„ À»  ‘œÂ «” ','«Œÿ«—',MB_OK+MB_ICONEXCLAMATION)
                                 else begin
                                       sherkat_aq.Close;
                                       sherkat_aq.SQL.Clear;
                                       ...
                                       sherkat_aq.ExecSQL;
                                       Application.MessageBox('Ìﬂ ‘—ﬂ  »« „Ê›ﬁÌ  À»  ‘œ',' ÊÃÂ ',MB_OK+MB_ICONINFORMATION);
                                      end;
                              end;
...
if key=13 then begin
                 if  (amal.Caption = '«÷«›Â') then
                          address.SetFocus
                                       ...
                                       if sherkat_aq.RecordCount=0 then
                                             Application.MessageBox('·ÿ›« Ìﬂ ‰«„ „⁄ »— »—«Ì ‘—ﬂ  „‘Œ’ ‰„«ÌÌœ','«Œÿ«—',MB_OK+MB_ICONEXCLAMATION)
                                                          else begin
...
{if megh_mas.Text='' then begin
                           Application.MessageBox('·ÿ›« „ﬁœ«— „’—›Ì œ— Â— „«Â —« „‘Œ’ ‰„«ÌÌœ',' ÊÃÂ',0);
                           megh_mas.SetFocus;
                          end;}
end;
...
{if (e<>0) then begin
                   Application.MessageBox('·ÿ›« „»·€ ﬁ—«—œ«œ ( ﬂ—«ÌÂ Â— ·Ì — ) —« „‘Œ’ ‰„«ÌÌœ',' ÊÃÂ',0);
                   mablaghl.SetFocus;
                 end;}
end;
...
if (modat.Text='') or (e<>0) then begin
                        Application.MessageBox('·ÿ›« „œ  ﬁ—«—œ«œ —«  ⁄ÌÌ‰ ‰„«ÌÌœ',' ÊÃÂ',0);
                        modat.SetFocus;
                       end;
end;
...
{if tel.Text='' then begin
                        Application.MessageBox('·ÿ›«  ·›‰ Ì« ›«ﬂ” ‘—ﬂ  —« Ê«—œ ‰„«ÌÌœ',' ÊÃÂ',0);
                        tel.SetFocus;
                     end;}
end;
...
if (e<>0) then begin
                   Application.MessageBox('·ÿ›« „»·€ ﬁ—«—œ«œ ( ﬂ—«ÌÂ Â— ﬂÌ·Êê—„ ) —« „‘Œ’ ‰„«ÌÌœ',' ÊÃÂ',0);
                   mablaghk.SetFocus;
                 end;}
end;
