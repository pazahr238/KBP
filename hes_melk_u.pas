...
if amal.Caption='«÷«›Â' then begin
                               ...
                               hes_melk_aq.Open;
                               if hes_melk_aq.RecordCount>0 then begin
                                                                    Application.MessageBox('„Ê—œÌ »« «Ì‰ ‘„«—Â ”‰œ Ê ‘—Õ À»  ‘œÂ «” ',' ÊÃÂ',0);
                                                                    exit;
                                                                  end
                                else begin
                                       hes_melk_aq.Close;
                                       ...
                                       if mashin.Text='Â“Ì‰Â Â«Ì ‘—ò ' then
                                          hes_melk_aq.Parameters[1].Value:='Â“Ì‰Â Â«Ì ‘—ò ' else
                                       ...
                                       if az.Text='Õ”«» »«‰ﬂÌ' then hes_melk_aq.Parameters[7].Value:=StrToInt64(hesab.Text);
                                       ...
                                       { if az.ItemIndex=0 then begin
                                        ...
                                        if az.ItemIndex=1 then begin
                                                                   ...
                                                                   hes_melk_aq.Open;
                                                                   if hes_melk_aq.RecordCount>0 then begin
                                                                                                        Application.MessageBox('›«ﬂ Ê— Å—œ«Œ Ì À»  ‘œ «„« çﬂ „—»ÊÿÂ ﬁ»·« À»  ‘œÂ Ê ‰Ì«“Ì »Â À»  „Ãœœ ‰Ì” ',' ÊÃÂ',0);
                                                                                                        //exit;
                                                                                                      end
                                                                                                  else
                                                                     begin
                                                                      ...
                                                                      hes_melk_aq.Parameters[5].Value:=mablagh.Value;
                                                                       ...
                                                                       if mashin.Text='Â“Ì‰Â Â«Ì ‘—ò ' then
                                                                          hes_melk_aq.Parameters[6].Value:='Â“Ì‰Â Â«Ì ‘—ò ' else
...
if amal.Caption=' €ÌÌ—' then begin
                               ...
                               hes_melk_aq.Open;
                               if hes_melk_aq.RecordCount<=0 then begin
                                                                    Application.MessageBox('„Ê—œÌ »—«Ì  €ÌÌ— ÅÌœ« ‰‘œ',' ÊÃÂ',MB_OK+MB_ICONSTOP);
                                                                    exit;
                                                                  end
                                else begin
                                       allow_change:=true; 
                                ...
                                then begin
                                       ...
                                       { if az.ItemIndex=0 then begin
                                        ...
                                        if az.ItemIndex=1 then begin
                                                                  ...
                                                                  if mashin.Text='Â“Ì‰Â Â«Ì ‘—ò ' then
                                                                      hes_melk_aq.Parameters[3].Value:='Â“Ì‰Â Â«Ì ‘—ò ' else
                                                                        hes_melk_aq.Parameters[3].Value:=mashin.Text;

                                                                  hes_melk_aq.ExecSQL;
                                                                end;
                                      Application.MessageBox('Ìﬂ ”‰œ Õ–› ‘œ',' ÊÃÂ',MB_OK+MB_ICONSTOP);
                                      //close;
                                      end;
                            end;
...
if ((chek.Text='') or (e<>0))
                           then
                              begin
                                Application.MessageBox('·ÿ›« ‘„«—Â çﬂ —« Ê«—œ ‰„«ÌÌœ',' ÊÃÂ',MB_OK+MB_ICONWARNING);
                                chek.Clear;
                                chek.SetFocus;
                                exit;
                               end;
...
begin
if (mashin.Text='') or ((not check_par(mashin.Text)) and (mashin.Text<>'Â“Ì‰Â Â«Ì ‘—ò ')) then
                        begin
                         Application.MessageBox('·ÿ›« Å—œ«Œ  ò‰‰œÂ —« „‘Œ’ ‰„«ÌÌœ',' ÊÃÂ',MB_OK+MB_ICONEXCLAMATION);
                         mashin.text:='';
                         mashin.SetFocus;
                        end;
end;
...
if (e=0) then
    begin
     ...
     if (hesab.Text='') or (hesab_aq.RecordCount=0) or (e<>0)
                 then
                    begin
                      Application.MessageBox('·ÿ›« ‘„«—Â Õ”«» —«  ⁄ÌÌ‰ ‰„«ÌÌœ',' ÊÃÂ',MB_OK+MB_ICONERROR);
                      hesab.SetFocus;
                      hesab.Text:='';
                     end;
end;
